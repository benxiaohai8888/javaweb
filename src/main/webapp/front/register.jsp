...
<body>
	...
	<div class="container">
		...
		<div class="content-reg">
			...
			<!-- 注册表单 -->
			<div class="reg-form">
				<form action="vipusercontrl/reg" method="post">
					<div class="controls">
						<p>用户名：</p>
						<input type="text" class="input03 w450" name="loginname"
							id="loginname" required autofocus>
					</div>
					<div class="controls">
						<p>密码：</p>
						<input type="text" class="input03 w450" name="loginpwd"
							id="loginpwd" required placeholder="密码至少6位数">
					</div>
					<div class="controls">
						<p>确认密码：</p>
						<input type="text" class="input03 w450" name="renpwd" id="renpwd"
							required placeholder="密码至少6位数">
					</div>
					<div class="controls">
						<p>手机号：</p>
						<input type="text" class="input03 w450" name="mobile" id="mobile"
							required id="mobile">
					</div>
					<div class="controls">
						<input type="button" value="获取验证码" class="btn06 w450"
							onclick="getMobileCode();">
					</div>
					<div class="controls">
						<p>验证码：</p>
						<input type="text" class="input03 w450" name="mobilecode"
							id="mobilecode" required>
					</div>
					<div class="controls">

						<div class="pact-radio" style="margin-left: 180px;">
							<input type="checkbox" /> <a href="javascript:;" class="pact">《超鲜网用户协议》</a>
						</div>
					</div>
					<div class="controls">
