		...
		<div class="container">
			...
			<div class="bread-crumbs">
				...
				<span><i class="fa fa-angle-double-right"></i></span> <a
					href="javascript:;" class="selected">基本信息</a>
			</div>
			<!-- 会员左侧 -->
			<div class="member-left">
				<dl>
					<dt>会员中心</dt>
					<dd>
						<a href="vipusercontrl/baseinfo" target="rightframe"
							class="menuPro-first selected">基本信息</a>
					</dd>
					<dd>
					...
					<dd>
						<a href="javascript:;" class="menuPro-first selected"><i
							class="fa fa-plus-square"></i>升级会员</a>
						<div class="menuPro-second" style="display: none;">
							<a href="companyvipcontrl/preupgradeprovider" target="rightframe"><i
								class="fa fa-angle-right"></i>升级供应商</a> <a href="javascript:;"><i
								class="fa fa-angle-right"></i>升级采购商</a> <a href="javascript:;"><i
								class="fa fa-angle-right"></i>升级承运方</a> <a href="javascript:;"><i
								class="fa fa-angle-right"></i>升级托运方</a> <a href="javascript:;"><i
								class="fa fa-angle-right"></i>提交成功</a> <a href="javascript:;"><i
								class="fa fa-angle-right"></i>其他状态页面</a>
						</div>
					</dd>
					<dt>供应商管理</dt>
					<dd>
						<a href="javascript:;" class="menuPro-first">我的资源单</a>
					</dd>
					<dd>
					...
					<dt>采购管理</dt>
					<dd>
						<a href="javascript:;" class="menuPro-first">我的采购单</a>
					</dd>
					<dd>
			...
			<div class="member-right">
				<iframe id="rightframe" name="rightframe" frameborder="0"
					src="vipusercontrl/baseinfo" width="100%"></iframe>
			</div>
		</div>
	</div>
