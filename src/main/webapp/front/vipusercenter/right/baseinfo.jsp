			...
			<div class="member-column">
				...
				<div class="member-exclusive">
					...
					<div class="exclusive-con">
						...
						<a href="javascript:;" class="exclusive-qq"><img
							src="front/images/member-qq.png" alt=""></a>
					</div>
				</div>
				<div class="member-tit">
					<p>基本资料</p>
				</div>
				<form action="vipusercontrl/updatebaseinfo" method="post" enctype="multipart/form-data">
					<div class="member-con">
						<input type="hidden" name="userid" value="${vipuser.userid }" />
						<div class="controls">
							<p>
								<span>*</span>用户名：
							</p>
							<div class="basic-name">${vipuser.loginname }</div>
						</div>
						<div class="controls">
							<p>昵称：</p>
							<input type="text" class="input03 w250" name="nickname">
						</div>
						<div class="controls">
							<p>头像：</p>
							<div class="upload-controls">
								<div class="upload-img head-img" id="imgdiv">
									<img src="front/images/upload-img01.png" alt="" id="imgshow">
								</div>
								<input type="button" value="点击上传" class="upload-btn w100"
									onclick="chooseImage();"> <input type="file" name="pic"
									id="pic" style="display: none;" />
							</div>
							<div class="tip">
								<em>1、上传文件要求为清晰照片；尺寸为正方形</em> <em>2、照片要求格式为jpg、jpeg、gif或png，大小不要超过3M。</em>
							</div>
						</div>
						<div class="controls">
							<p>手机号：</p>
							<div class="basic-tel">${vipuser.mobile }</div>
						...
						<div class="controls">
							<p>省份：</p>
							<!-- class="selectpicker" -->
							<select data-width="252" id="province">
								<option value="0">请选择</option>
							</select>
						</div>
						<div class="controls">
							<p>城市：</p>
							<select data-width="252" id="city">
								<option value="0">请选择</option>
							</select>
						</div>
						<div class="controls">
							<p>地区：</p>
							<select data-width="252" id="area" name="area.id">
								<option value="0">请选择</option>
							</select>
						</div>
						<div class="controls">
